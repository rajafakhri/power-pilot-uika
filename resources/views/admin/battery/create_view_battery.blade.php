    ...
    <div class="content">
        ...
        <div class="row">
            ...
            <div class="page-title-box">
                ...
                <h4 class="page-title">Add Battery</h4>
            </div>
            </div>
        </div>
        <!-- end page title -->
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title">Add Battery</h4>
                                        ...
                                        <form id="form add-battery-f" action="{{ route('battery.store') }}" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select name="id_users" id="idUsers" class="form-control @error('id_users') is-invalid @enderror" >
                                                    ...
                                                    <option value="{{ $id_us->id }}">{{ $id_us->name }}</option>
                                                    @endforeach
                                                </select>
                                                @error('id_meters')
                                                <span class="invalid-feedback" role="alert">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" id="simpleinput" class="form-control @error('nm_battery') is-invalid @enderror" name="nm_battery" value="{{old('nm_battery')}}">
                                                @error('nm_battery')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                            ...
                                            <button type="submit" id="add-battery-b" class="btn btn-primary">Submit</button>
                                        </form>
                                    </div> <!-- end col -->
                                </div>
                                <!-- end row-->                      
...
$('#add-battery-f').submit(function () {
    $('#add-battery-b').attr('disabled',true);
});
</script>
@endsection