    ...
    <div class="content">
        ...
        <div class="row">
            ...
            <div class="page-title-box">
                ...
                <h4 class="page-title">Battery</h4>
            </div>
            </div>
        </div>

        <div class="col-auto">
            <a href="{{route('battery.create')}}" class="btn btn-primary">Create New</a>      
        </div>
        <br>
        <!-- end page title -->
            ...
            <table class="table table-centered table-nowrap mb-0">
                ...
                <tbody>
                    ...
                    <tr>                                                
                        ...
                        <td>
                            <form onsubmit="return confirm('Are you sure ?');" action="{{ route('battery.destroy', $data->id_battery) }}" method="POST">
                                <a class="btn btn-primary" href="{{route('battery.edit', $data->id_battery)}}" class="action-icon"> <i class="mdi mdi-square-edit-outline"></i></a>                                                        
                                @csrf
                                @method('DELETE')
